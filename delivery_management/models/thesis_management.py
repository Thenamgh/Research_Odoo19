...
class ThesisProject(models.Model):
    ...
    name = fields.Char(string='Project Reference', required=True, copy=False, readonly=True, default=lambda self: 'NEW')
    ...
    assigned_by = fields.Many2one('res.users', string='Assigned By', readonly=True, default=lambda self: self.env.user)
